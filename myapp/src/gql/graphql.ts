...
export type File_FragmentFragment = { __typename?: 'PostFile', id: string, url: string, postId: string, contentType: string, fileSize: number } & { ' $fragmentName'?: 'File_FragmentFragment' };

export type Post_FragmentFragment = { __typename?: 'Post', id: string, title: string, description: string, variant: string, type: Type, language: LanguageType, createdAt: any, updatedAt: any, files: Array<(
    { __typename?: 'PostFile' }
