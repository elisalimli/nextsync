...
export type Post_FragmentFragment = { __typename?: 'Post', id: string, title: string, files: Array<{ __typename?: 'PostFile', id: string, url: string, postId: string, contentType: string }> } & { ' $fragmentName'?: 'Post_FragmentFragment' };
